...
To update the database use this command from the Web project folder (replace `CleanAPI.Games` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../CleanAPI.Games.Infrastructure/CleanAPI.Games.Infrastructure.csproj -s CleanAPI.Games.Web.csproj
```
